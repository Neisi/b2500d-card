...
//RENDER COMPACT
    ...
    _renderSolar(lang){
        ...
        return html`
            ...
            <div style="width: 85%;">
            <div class="barlabels">
              ${this._p1 != null ? html`<div @click=${() => this._handleMoreInfo(this._getEntity("input_1_power"))}>${this._p1} W</div>` : ""}
              ${this._p2 != null ? html`<div @click=${() => this._handleMoreInfo(this._getEntity("input_2_power"))}>${this._p2} W</div>` : ""}
            ...
            <div class="barwrap">
            ${this._p1 != null ? html`<div class="bar"><div class="fill" style="width:${p1Pct}%"></div></div>`
              : ""}
            ${this._p2 != null ? html`<div class="bar"><div class="fill" style="width:${p2Pct}%"></div></div>`
              : ""}
            ...
            <div class="barlabels">
            ${this._p1 != null ? html`<div class="hint">P1</div>` : ""}
            ${this._p2 != null ? html`<div class="hint">P2</div>` : ""}
